	...
	return (
		<div className="relative top-[140px] w-auto flex flex-col items-center">
			<div className="m-[20px] bg-gradient-to-b from-bloo to-purp backdrop-blur-sm from-0% to-70% shadow-lg rounded-[10px] p-5">
				<div id="this" className={"relative overflow-y-scroll max-h-[412px] max-w-[412px]"}>
					<ScrollButton />
					<h1 className={"text-litbloo text-2xl relative text-center mb-2"}>{t('payment1')}</h1>
					...
					<br/>
					<h3 className={"text-md text-litbloo"}>
						{t('payment15')}
					</h3>
					...
					<div className={"flex flex-row justify-between w-[100px] mt-2 ml-1"}>
						<a href="https://wa.me/message/WZZPEKZTMVQOJ1" target="_blank">
							<Image className={"transition duration-500 ease-in-out hover:scale-120"} src={wa} alt="Whatsapp" height="35"/>
						</a>
						<a href="https://t.me/easypayhk" target="_blank">
							<Image className={"transition duration-500 ease-in-out hover:scale-120"} src={tg} alt="Telegram" height="35"/>
						</a>
					</div>
