...
export default function Nav({shop, purchase, tos}) {
      ...
      case '/tos' :
        guts = (
          <>
            ...
            <li className={"drop-shadow-lg inline-block w-[100px] px-[4px] rounded-[10px] bg-gradient-to-t from-transparent from 40% to-white/10 shadow-md shadow-black/40"}>{tos}</li>
          </>
        ); 
        break;
  }
  ...
  return (
  <nav className={"relative w-full text-center top-[130px] flex justify-center"}>
    <ul className={"p-[8px] w-350 flex justify-evenly shadow-md shadow-black/40 rounded-[10px] bg-gradient-to-b from-bloo to-purp"}>
      {guts}
    </ul>
  </nav>
  )
