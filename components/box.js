      ...
      <>
        ...
        <div className={"flex flex-row flex-wrap justify-center gap-5"}>
          <div
            id="this"
            className={
              "block max-h-[300px] max-w-[490px] min-w-[200px] overflow-y-scroll flex-1 basis-40 relative"
            }
          >
            <ScrollButton />
            ...
            <p>
              <span className={"text-gree"}>{t("discord4")}</span>
              <br />
              {t("discord5")}
              <br />
              {t("discord6")}
            ...
            <hr className="h-[3px] w-full border-0 my-4 rounded bg-gradient-to-r from-gree via-pin to-pur" />
            <p>
              <span className={"text-gree"}>{t("discord7")}</span>
            </p>
            ...
            <hr className="h-[3px] w-full border-0 my-4 rounded bg-gradient-to-r from-gree via-pin to-pur" />
            <p>
              <span className={"text-gree"}>{t("discord10")}</span>
            </p>
            <ul className={"list-disc list-inside"}>
              <li>{t("discord11")}</li>
              <li>{t("discord12")}</li>
          ...
          <div
            className={
              "w-full flex-1 flex flex-col justify-start items-center min-w-[200px]"
            }
          >
      ...
      <>
        ...
        <div className={"flex flex-row flex-wrap justify-center gap-5"}>
          ...
          >
            ...
            <p>{t("spotify2")}</p>
            <hr className="h-[3px] w-full border-0 my-4 rounded bg-gradient-to-r from-gree via-pin to-pur" />
            <span className={"text-gree"}>{t("spotify7")}</span>
            <br />
            {t("spotify8")}
            <hr className="h-[3px] w-full border-0 my-4 rounded bg-gradient-to-r from-gree via-pin to-pur" />
            <span className={"text-gree"}>{t("spotify3")}</span>
            <ol className={"list-decimal list-inside"}>
              <li>{t("spotify4")}</li>
              <li>{t("spotify5")}</li>
            </ol>
  ...
  return (
    <>
      <div className="relative top-[130px] w-auto flex flex-col items-center">
        <div
          className={
            "bg-gradient-to-b from-bloo to-purp from-0% to-70% backdrop-blur-sm shadow-lg rounded-[10px] max-w-[800px] flex flex-col p-[40px] mx-[20px]"
          }
        >
          {guts}
        </div>
